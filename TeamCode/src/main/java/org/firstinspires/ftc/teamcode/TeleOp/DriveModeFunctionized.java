 ...
 */
@TeleOp(name="Tele-OP Functionized", group = "Main")

public class DriveModeFunctionized extends Central {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.x){
                pullServo.setPosition(pullServo.getPosition() + 0.01);
                sleep(30);
            }
            else if (gamepad2.b){
                pullServo.setPosition(pullServo.getPosition() - 0.01);
    ...
    public void RegularMode() throws InterruptedException{
    ...
    public void CrawlMode() throws InterruptedException{
