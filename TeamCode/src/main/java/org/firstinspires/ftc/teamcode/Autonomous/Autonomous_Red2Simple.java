 ...
 */
@Autonomous(name = "Red 2 Simple", group = "Autonomous")

public class Autonomous_Red2Simple extends Central {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()) {
            ...
            switch(position){
                case 0:         //Left
                    driveTrainEncoderMovement(0.5, 46-8.1-8.6, 10, 100, movements.forward);
            ...
            driveTrainEncoderMovement(0.7, DEGREE_90, 10, 100, movements.ccw);            driveTrainEncoderMovement(0.7, 2, 10, 100, movements.forward);
